...
function OnLoad()
	Variables()		
	AhriMenu()
	PrintChat("<font color='#FFFFFF'> >> ProAhri by Galaxix v1.0 Loaded ! <<</font>")
end
...
function Variables()
	...
	qSpeed, qDelay, qWidth = 2500, 0.25, 100
	eSpeed, eDelay, eWidth = 1000, 0.25, 60
...
function Combo()
	...
	if Target ~= nil then
		if AhriMenuu.combo.comboItems then UseItems(Target) end
